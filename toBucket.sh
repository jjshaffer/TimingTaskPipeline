...
CONTRAST=BD_TMSvSHAM_Timing_Long-Short
#CONTRAST=BD_TMSvSHAM_Timing_Long-Imm
#CONTRAST=BD_TMSvSHAM_Timing_Long-Fix
...
CONTRAST=BDvHC_Timing_Long-Short
#CONTRAST=BDvHC_Timing_Long-Imm
#CONTRAST=BDvHC_Timing_Long-Fix

3dbucket -prefix ${CONTRAST}_BUCKET_FDR.nii.gz \
${CONTRAST}_BD_t.nii.gz \
${CONTRAST}_BD_1-p.nii.gz \
${CONTRAST}_BD_1-pImage_FDR.nii.gz \
${CONTRAST}_Group_t.nii.gz \
${CONTRAST}_Group_p.nii.gz \
${CONTRAST}_Group_1-p.nii.gz \
${CONTRAST}_Session_t.nii.gz \
